...
# # trafic light code 
# light=input("enter the current color of the traffic signal=")
# if(light=="red"):
#     print("Stop")
# elif(light=="yellow"):
#     print("Look then move")
# elif(light=="green"):
#     print("You can move")
# else:
#     print("give the correct input color or Light is broken.")
...
# print("Hello",name,"you will be", age+10, "years old after 10 years.")

#Take two numbers as input and print all arithmetic operations (sum, difference, product, division, floor division, modulus, power) on them.
# num1=float(input("enter the first number="))
# num2=float(input("enter the second number="))
# sum=num1+num2
# print("sum of both the number",sum)
# diffrence=num1-num2
# print("diffrence of both the number",diffrence)
# product=num1*num2
# print("product of both the number",product)
# division=num1/num2
# print("division of both the number",division)
# floor_division=num1//num2
# print("floor_division of both the number",floor_division)
# modulus=num1%num2
# print("modulus of both the number",modulus)
# power=num1**num2
# print("power of both the number",power)
...
# string=input("Enter the complete you want to print=")
# print(string)
# print("the lenght of the given string is",len(string))
# print("the first character of the string is",string[0])
# print("the last cahracter of the string is",string[len(string)-1])
# print("the reverse of the given string is",string[::-1])   # these is the method how we can reverse the string..
...
# print("number of a in the sentence is",string.count("a"))
# print("number of e in the sentence is",string.count("e"))
# print("number of i in the sentence is",string.count("i"))
# print("number of o in the sentence is",string.count("o"))
# print("number of u in the sentence is",string.count("u"))

# Take the price of an item and a discount percentage as input. Calculate and print the final price after discount. If the final price is above 1000, print "Expensive", between 500–1000 print "Moderate", and below 500 print "Affordable".
# price=float(input("what is the price of the product="))
# discount_percent=float(input("what is the discount percent on the product="))
# final_price=price-((discount_percent/100)*price)
# print(final_price)
# if(final_price>1000):
#     print("Expensive")
# elif(1000>=final_price>=500):
#     print("Moderate")
# else:
#     print("Affordable")     
    
# # Take two numbers and an operator (+, -, *, /) as input from the user and perform that operation. Handle the case where the user enters an invalid operator.      
# num1=float(input("enter the first number="))
# num2=float(input("enter the second number="))
# operator=input("enter the operator you want me to handel=")
# if(operator=="+"):
#     print(num1+num2)
# elif(operator=="-"):
#     print(num1-num2)
...
#     print(num1**num2)
# else:
#     print("the operator you gave is invalid") 
    
    
# Take a string as input and print how many times each vowel appears in it. Also print whether the string starts and ends with the same character.                     
...
# # checking for same character
# if(string[0]==string[len(string)-1]):
#     print("yes the staring and ending character is same")
# else:
#     print("the starting and ending character is not same")   
     
# A shopkeeper gives discounts based on the total bill — 5% for bills above ₹500, 10% above ₹1000, and 20% above ₹2000. Take the bill amount and quantity of items as input, calculate the final amount after discount, and print a formatted receipt showing original price, discount percentage, discount amount, and final price
# no_of_product=int(input("enter the number of product you have buyed="))
# if no_of_product >= 1:
#     name_of_product_1 = input("Enter name_of_product_1: ")
#     price_of_product_1 =float(input("enter the price of product 1:"))
# if no_of_product >= 2:
#     name_of_product_2 = input("Enter name_of_product_2: ")
#     price_of_product_2 =float(input("enter the price of product 2:"))
# if no_of_product >= 3:
#     name_of_product_3 = input("Enter name_of_product_3: ")
#     price_of_product_3 =float(input("enter the price of product 3:"))
# if no_of_product >= 4:
#     name_of_product_4 = input("Enter name_of_product_4: ")
#     price_of_product_4 =float(input("enter the price of product 4:"))
# if no_of_product >= 5:
#     name_of_product_5 = input("Enter name_of_product_5: ")
#     price_of_product_5 =float(input("enter the price of product 5:"))
# if no_of_product >= 6:
#     name_of_product_6 = input("Enter name_of_product_6: ")
#     price_of_product_6 =float(input("enter the price of product 6:"))
      
# final_price=price_of_product_1+price_of_product_2+pice     
